...
The database, database users and the database schema must be already created before TimeTurner is deployed.

{% hint style="warning" %}
Service will not be properly executed if the database schema is not already available in the database.
{% endhint %}
