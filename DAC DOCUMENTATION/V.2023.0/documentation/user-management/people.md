---
description: Contains the list of users in the Application
---
...
The Filters item, on the top left,  allow you to filter the list of user.
...
* The **Three points**  icons on the rigth allow to opens the menu on the bottom and it's possible to Send a Message.
