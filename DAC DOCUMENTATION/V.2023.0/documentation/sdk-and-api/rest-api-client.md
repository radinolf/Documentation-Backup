...
* Program
* Custom Widget and [Data Connector](/broken/pages/Qtn0MlREI33Cd8HDgaIJ)
...
{% hint style="info" %}
You can use **Environment Eariables** in the API. To know which environment variables to use see  [App Composer Environment Variable](/broken/pages/Z11vnQKECZlPpKVc4o7e)
