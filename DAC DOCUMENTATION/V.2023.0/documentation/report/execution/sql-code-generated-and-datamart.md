...
![](<../../../.gitbook/assets/14 (12).png>)The SQL code generated by DAC and executed in DataWarehouse is displayed in the _**Query Viewer**_ window, opened using one of the buttons of the _Editing Report_ window.
