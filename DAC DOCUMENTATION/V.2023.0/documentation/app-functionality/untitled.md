...
Notifications can be sent instantly, by clicking the ![](<../../.gitbook/assets/1 (29).png>) button.
...
selecting the ![](<../../.gitbook/assets/4 (26).png>) button will enter the keyword %SUBJECT%; this will be replaced by the corresponding recipient username, when the notification is sent.
...
{% hint style="danger" %}
These features **Report** (**pdf** and **text**), **Page** (**pdf** and **text)**&#x68;as been deprecated and it will be removed in a later version. Please refer to the changelog for additional information.
{% endhint %}
