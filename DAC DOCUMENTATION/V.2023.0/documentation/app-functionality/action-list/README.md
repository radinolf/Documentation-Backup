...
In the picture above, you can see that one action is completed with additional information ![](<../../../.gitbook/assets/image (732).png>) and one action raised an error ![](<../../../.gitbook/assets/image (968).png>). You can click on the icon to display the details
...
**DETAILS**  In the DETAILS tab we name the schedule (Name) and optionally a description.

**FREQUENCY** To define the frequency you need to set:
...
* **Period:** the period of execution (day, month etc)![](<../../../.gitbook/assets/image (644).png>)
...
**Cron Time String:** it is possible to define a more complex scheduling using a [crontab expression](https://en.wikipedia.org/wiki/Cron). Below some examples crontab expressions.<br>
...
<table><thead><tr><th width="100">Icon</th><th width="170">Status</th><th>Description</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/image (129).png" alt=""></td><td>Running</td><td>Currently in execution</td></tr><tr><td><img src="../../../.gitbook/assets/image (648).png" alt=""></td><td>Enabled</td><td>Ready to be executed</td></tr><tr><td><img src="../../../.gitbook/assets/image (657).png" alt=""></td><td>Disabled</td><td>It will not be excuted at the defined scheduling</td></tr><tr><td><img src="../../../.gitbook/assets/image (216).png" alt=""></td><td>Expired</td><td>It is expired because the end date has been reached</td></tr><tr><td><img src="../../../.gitbook/assets/image (491).png" alt=""></td><td>Error</td><td>The last execution raised an error</td></tr><tr><td><img src="../../../.gitbook/assets/image (482).png" alt=""></td><td>Unkown Status</td><td>System failed to recover the status of the scheduling</td></tr></tbody></table>
...
The pencil icon![](<../../../.gitbook/assets/image (767).png>) shows the fields that can be modifed. Once you click the enter button, the new value is saved.
