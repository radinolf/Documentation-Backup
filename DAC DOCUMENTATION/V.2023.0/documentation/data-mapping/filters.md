...
![](<../../.gitbook/assets/12 (6).png>)![](<../../.gitbook/assets/13 (22).png>)
...
Range filters define conditions on the metrics, already defined with the [Metrics Management](metrics/) module.
...
or from the toolbar, using the ![](<../../.gitbook/assets/16 (1).png>) button.
