...
or from the toolbar button ![](<../../../.gitbook/assets/1 (20).png>) .
...
![SNAGHTML18d4897](<../../../.gitbook/assets/3 (9).png>)
...
* _**Remote,**_ on a remote database. Selecting ![](<../../../.gitbook/assets/7 (6).png>)this item enables the menu with the list of data sources configured using the [Datasource Designer](/broken/pages/-MfHrzbfigrQbGP53aPH#_Server_NT) module:
...
Dimension levels![](<../../../.gitbook/assets/13 (14).png>)
