...
Use the ![](<../../../.gitbook/assets/1 (29).png>) button to update the above-listed information.

All the objects created in the application may be exported in the CSV format by selecting the ![](<../../../.gitbook/assets/2 (28).png>) button.
