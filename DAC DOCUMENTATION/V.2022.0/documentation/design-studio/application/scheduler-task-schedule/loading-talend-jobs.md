...
An [**Execute button**,](/broken/pages/-MgnwoeR4rnLcH21DIFw#execute-button) of a TALEND\_INTEGRATION type
...
The list of Jobs imported into the DAC is available in the [_**Administration>> Jobs**_](../../../run-time/administration/jobs.md) _**section of Run Time.**_
