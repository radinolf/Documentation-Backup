...
Note: -_Cells with text wrap option have the_ ![](<../../../../.gitbook/assets/4 (27).png>) _Button. You can remove this option by first selecting the cell and then clicking the wrap text button._![](<../../../../.gitbook/assets/5 (17).png>)_._
...
The ![](<../../../../.gitbook/assets/9 (18).png>) symbol indicates that the property has been set in _override_. To change them, just open the application properties and deselect override .
