...
Page type prompts are usually used to define filters that perform better than page-bys, as well as to insert components that enrich the report itself (indicators, graphs, etc.). The Page should be created in advance with the _Page Designer_ _module._
