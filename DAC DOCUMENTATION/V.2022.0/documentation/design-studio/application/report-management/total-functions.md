...
![](<../../../../.gitbook/assets/2 (27).png>)In the _**Operations**_ section we choose the type of total function to apply to the report, divided in the following groups:
...
_with \<entire-result> , , they are not aggregated by BU, so we carry out a sum of the BU for_ ![](<../../../../.gitbook/assets/16 (16).png>)_all quarters () and then we divide by the BU of all quarters ()_![](<../../../../.gitbook/assets/17 (18).png>)_)_
...
The ![](<../../../../.gitbook/assets/37 (8).png>) button of the totals command bar opens the _**Custom Total**_ window where it is possible to select a series of functions grouped by topic:
