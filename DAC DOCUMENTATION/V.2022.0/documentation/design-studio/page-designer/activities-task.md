...
_From Page Designer, we enter the graph-type component and in the TITLE section we enable the property activate-task. The graph in DAC will display the task button next to the title_![](<../../../.gitbook/assets/88 (1).png>)_. Clicking the button opens the window for inserting the new task._
...
selecting the ![](<../../../.gitbook/assets/134 (1).png>) button will enter the keyword %SUBJECT%; this will be replaced by the corresponding recipient username, when the notification is sent.
