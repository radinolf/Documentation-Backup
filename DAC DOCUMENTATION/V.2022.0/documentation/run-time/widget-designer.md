...
To find out which widgets the DAC has, we advise you to consult the documentation accessible from the link below:
...
**Published:** Whether the widget is published or not. When published it shows the icon ![](<../../.gitbook/assets/3 (1)>)

**API Version:** Shows the API version (minimum, maximum). This allows you to define widget compatibility when importing and / or installing or updating widgets.
...
![https://gblobscdn.gitbook.com/assets%2Fpothole%2F-Me4UcB3LybUNCnFdfgt%2F-Me4W9R50g3LjxjNzGPU%2F6.png?alt=media](<../../.gitbook/assets/14 (2)>)
