...
Notifications can be sent instantly, by clicking the ![](<../../.gitbook/assets/1 (5).png>) button.
...
selecting the ![](<../../.gitbook/assets/4 (2).png>) button will enter the keyword %SUBJECT%; this will be replaced by the corresponding recipient username, when the notification is sent.
