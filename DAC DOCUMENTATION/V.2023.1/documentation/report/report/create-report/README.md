...
* To create,clicking on the button ![](<../../../../.gitbook/assets/image (1098).png>)
* To change, select the button below, which is only activated for already open reports ![](<../../../../.gitbook/assets/image (1018).png>)
...
The Metrics element ![](<../../../../.gitbook/assets/11 (24).png>) groups the metrics. These are initially placed in columns. Later they can be moved through drag & drop operations like those for dimensional levels.
