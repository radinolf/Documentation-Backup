...
In the _weighted arithmetic average_ of the values ![](<../../../.gitbook/assets/image (146).png>), a _weight_ ![](<../../../.gitbook/assets/image (1200).png>) is assigned to each value: ![](<../../../.gitbook/assets/image (197).png>).
...
The calculation of the average requires you to sum the weighted values and divide![](<../../../.gitbook/assets/image (64).png>) them, not with respect to the number of the values but rather to the sum of the weights. Therefore the formula of the weighted average ![](<../../../.gitbook/assets/image (438).png>)is:
