...
* [​Execute Button](https://widgets.decisyon.com/button-1/v/execute-button-1/)
* [Snippet](code-snipped-editor/)
* [Custom Widget and Data Connector](../widgets/widget-editor/)​
* [​Alert](../app-functionality/alert-and-rules/alert.md)
* [Action List](../app-functionality/action-list/)

It’s possible to use App Composer [Environment Variables](../introduction/application/overview-of-ui/general-info/#app-composer-environment-variable) in the REST client.
