...
Below is the section dedicated to **comments**: comments already entered and the section for sending a new comment. If the number of comments is greater than 10, the icon is shown to display the oldest comments
