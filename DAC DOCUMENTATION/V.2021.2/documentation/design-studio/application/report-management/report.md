...
The customization of report properties can take place, not only from the _Editing Report_ window, but also from the _Report Properties_ window which can be opened with the ![](<../../../../.gitbook/assets/1 (7).png>) Button.
...
The Metrics element ![](<../../../../.gitbook/assets/11 (1).png>) groups the metrics. These are initially placed in columns. Later they can be moved through drag & drop operations like those for dimensional levels.
...
* ![](<../../../../.gitbook/assets/12 (3).png>)the execution of the report
...
![](<../../../../.gitbook/assets/14 (3).png>)The SQL code generated by DAC and executed in DataWarehouse is displayed in the _**Query Viewer**_ window, opened using one of the buttons of the _Editing Report_ window.
...
![](<../../../../.gitbook/assets/23 (2).png>)The button at the top on the right side closes the main window from the layout of the last executed report.
...
The two arrows ![](<../../../../.gitbook/assets/28 (2).png>) at the beginning of the separation line are used to hide the graph (top arrow) or the table (bottom arrow).![](<../../../../.gitbook/assets/29 (4).png>)![](<../../../../.gitbook/assets/30 (4).png>)![](<../../../../.gitbook/assets/31 (2).png>)
...
You can open a report from the catalog by clicking on File >> Open report or directly from the toolbar with the ![](<../../../../.gitbook/assets/32 (1).png>) Button.

![](<../../../../.gitbook/assets/33 (3).png>)

To save a report click on the File >> Save menu item or >> Save as or use the corresponding commands on the toolbar ![](<../../../../.gitbook/assets/34 (1).png>).
...
![](<../../../../.gitbook/assets/53 (2).png>) ![](<../../../../.gitbook/assets/54 (2).png>)
...
You can define metrics mapping using the ![](<../../../../.gitbook/assets/63 (3).png>) button:
...
If the table contains both the key and the description fields, you define their association in the pop-up box, opened by clicking the ![](<../../../../.gitbook/assets/65 (2).png>) button:
...
Clicking the ![](<../../../../.gitbook/assets/67 (3).png>)button opens a window which allows you to define the aliases of the levels and metrics.
...
![SNAGHTML937592](<../../../../.gitbook/assets/69 (3).png>)
...
Step 2: **Metrics Mapping**![](<../../../../.gitbook/assets/70 (2).png>)
