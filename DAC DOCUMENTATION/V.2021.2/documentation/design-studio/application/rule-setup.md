...
To define the condition you need to click the ![](<../../../.gitbook/assets/3 (16).png>) button which opens a different window, according to the type of object selected in the _alertType_ property:
...
![Descrizione: SNAGHTML692740](<../../../.gitbook/assets/5 (19).png>)
...
To define the condition you need to click the ![](<../../../.gitbook/assets/7 (18).png>) button which opens a window to insert a single condition.
...
* The **SQL Action** to execute a SQL statement. To define the query you need to click the ![](<../../../.gitbook/assets/10 (16).png>) button which opens the query editor window.
...
* _To define the condition you need to click the_ ![](<../../../.gitbook/assets/14 (13).png>) _button to open the Simple Condition Editor. Define a condition for TAG SENSOR\_02 >100_
...
The ![](<../../../.gitbook/assets/16 (9).png>) button starts the wizard to test the rule.

![SNAGHTML6bdd0ab8](<../../../.gitbook/assets/17 (11).png>)
