...
or from the toolbar button ![](<../../../.gitbook/assets/1 (29).png>) .
...
![SNAGHTML18d4897](<../../../.gitbook/assets/3 (26).png>)
...
* _**Remote,**_ on a remote database. Selecting ![](<../../../.gitbook/assets/7 (22).png>)this item enables the menu with the list of data sources configured using the [Datasource Designer](/broken/pages/-MfHrzbfigrQbGP53aPH#_Server_NT) module:
...
Dimension levels![](<../../../.gitbook/assets/13 (20).png>)
...
To start the user filter wizard: from the menu bar, select **Data Model** and **User filter management**; otherwise from the tool bar, select the ![](<../../../.gitbook/assets/19 (13).png>) button.

![\\\fserver\projects\Manuali e training\Manuali\AppData\sdifranc\AppData\Local\Temp\SNAGHTML1655cc6.PNG](<../../../.gitbook/assets/20 (14).png>)
