...
To specify dimensioning for an _Advanced_ Metric, you must select the ![](<../../../.gitbook/assets/41 (2).png>) button.
...
![](<../../../.gitbook/assets/44 (3).png>)

_Create a new advanced metric (Qty For Week), inside the Sales cube folder, which calculates the quantity sold by week._

_Dimensioning by week is performed by accessing the Dimensions panel through the_ ![](<../../../.gitbook/assets/45 (3).png>) _button and selecting the Week level from the Sales cube._
...
![SNAGHTML5e2be9](<../../../.gitbook/assets/56 (2).png>)
...
_Open the window with the list of the time functions by pressing_ ![](<../../../.gitbook/assets/63 (2).png>)

_Double-click on the Last Year time function._

Step 2: **Report with Time Advanced Metric**

![](<../../../.gitbook/assets/64 (3).png>)
...
To access the _**Metric functions**_ window, press the ![](<../../../.gitbook/assets/69 (2).png>) button.

![](<../../../.gitbook/assets/70 (3).png>)
...
_Through the_ ![](<../../../.gitbook/assets/75 (2).png>)_button, access the window of the Metric Functions and select Sum function from the basic folder._

_Define partitioning for the Month dimensional level:_

* _Set by Default to No Partition_
* _Select the Month level from the_ ![](<../../../.gitbook/assets/76 (2).png>) _button_
...
![SNAGHTMLc1a1a4](<../../../.gitbook/assets/87 (1).png>)
...
| ------------------------------------------- | --------- |
| ![](<../../../.gitbook/assets/102 (1).png>) | **Trend** |
...
*
  * The component relating to the _**level of**_ _**the series**_, calculated in a similar way to Single Exponential Smoothing ![](<../../../.gitbook/assets/104 (1).png>)
...
If the cursor is placed on Root, the system enables the button at the top left ![](<../../../.gitbook/assets/127 (1).png>).
...
![SNAGHTML70d159](<../../../.gitbook/assets/137 (1).png>)
