...
The page defined for the drill-through is displayed in a new window, opened from the _**Detail>>**_ (in the information window associated with the marker).![](<../../.gitbook/assets/3 (1).png>)![](<../../.gitbook/assets/4 (1).png>)
...
#### Example: Gauge-Start-Angle and Gauge-End-Angle![](<../../.gitbook/assets/10 (10).png>)![](<../../.gitbook/assets/11 (10).png>)![](<../../.gitbook/assets/12 (9).png>)![](<../../.gitbook/assets/13 (10).png>)
...
The button to the right of the property opens a pop-up, where the name of the parameter is entered.![](../../.gitbook/assets/30.png)
...
Example: DATE type Text Field with date range![](<../../.gitbook/assets/37 (5).png>)![](<../../.gitbook/assets/38 (5).png>)
...
The ![](<../../.gitbook/assets/45 (6).png>) button opens a field for the rapid search of the element to be selected.

* On all the elements

Clicking the ![](<../../.gitbook/assets/46 (5).png>) button moves all the elements to be selected into the list of those selected.

Clicking the ![](<../../.gitbook/assets/47 (5).png>) button puts all the selected elements back in the list of the available ones.
...
![SNAGHTML7ee2d9](<../../.gitbook/assets/50 (5).png>)
...
Step 3: Execute button as DS and use the post-execution-button![](<../../.gitbook/assets/67 (6).png>)![](<../../.gitbook/assets/68 (6).png>)![](<../../.gitbook/assets/69 (6).png>)![](<../../.gitbook/assets/70 (5).png>)
...
In the _Attachments_ section, you can either select a report from the ![](<../../.gitbook/assets/78 (4).png>) button or a Page by selecting the.![](<../../.gitbook/assets/79 (4).png>) button.
...
* ![](<../../.gitbook/assets/100 (3).png>) **Discussions**

Allows discussions to be opened, possibly on a specific topic.

* ![](<../../.gitbook/assets/101 (3).png>) **Discussions stream**
...
_The second link displays the icon_ ![](<../../.gitbook/assets/116 (3).png>)_((\<img src="../../customizations/img/1297265268\_info.png" border="0" alt="Info Bubble Graph">)_
...
| ![](<../../.gitbook/assets/120 (4).png>)[Others](/broken/pages/-Mgnx9C6LGMGn1uwUlTx#_Others)                                                                                                                                                           | ![](<../../.gitbook/assets/121 (4).png>) [Users](/broken/pages/-Mgnx9C6LGMGn1uwUlTx#_User)         | ![](<../../.gitbook/assets/122 (4).png>) [Contents](/broken/pages/-Mgnx9C6LGMGn1uwUlTx#_Content)   | ![](<../../.gitbook/assets/123 (3).png>) [Sub-Spaces](/broken/pages/-Mgnx9C6LGMGn1uwUlTx#_Sub-Spaces) |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| <p><img src="../../.gitbook/assets/124 (3).png" alt=""> <a href="/broken/pages/-Mgnx9C6LGMGn1uwUlTx#_Signal">Signals</a></p><p><img src="../../.gitbook/assets/125 (3).png" alt=""> <a href="/broken/pages/-Mgnx9C6LGMGn1uwUlTx#_Task_2">Tasks</a></p> | ![](<../../.gitbook/assets/126 (3).png>) [Bookmarks](/broken/pages/-Mgnx9C6LGMGn1uwUlTx#_Bookmark) | ![](<../../.gitbook/assets/127 (3).png>) [Documents](/broken/pages/-Mgnx9C6LGMGn1uwUlTx#_Document) |                                                                                                       |
