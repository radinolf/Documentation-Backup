# Changes and migration of version 6.5.2
...
* **Decisyon App Composer for Docker** \
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.appcomposer-docker:LUDWIG.2.RELEASE
* **Decisyon App Composer for Kubernetes**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.appcomposer-k8s:LUDWIG.2.RELEASE
* **Cornelius Configuration Server**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.cornelius:LUDWIG.2.RELEASE
* **Keycloak OIDC Server**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.keycloak:LUDWIG.2.RELEASE
* **Gertrude Flowable Back-end**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.gertrude:LUDWIG.2.RELEASE
* **Flowable Modeler**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.flowable-modeler:LUDWIG.2.RELEASE
* **Decisyon Design Studio**\
  http://repository.decisyon.com/public/dac-designstudio/release/ludwig.2
