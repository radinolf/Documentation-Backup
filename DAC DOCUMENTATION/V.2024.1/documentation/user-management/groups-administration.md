...
* **Landing Page:** in Landing Page you can select the page that the users of the group access after logging in pages.When the page list opens, only pages that group was actively associated with during page creation in [App Builder ](../page-designer/create-and-publish-pages/#publish-the-page) will be visible.
