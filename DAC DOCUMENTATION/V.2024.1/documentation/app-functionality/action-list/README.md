...
In the picture above, you can see that one action is completed with additional information ![](<../../../.gitbook/assets/image (1017).png>) and one action raised an error ![](<../../../.gitbook/assets/image (883).png>). You can click on the icon to display the details
...
* **Period:** the period of execution (day, month etc)![](<../../../.gitbook/assets/image (1607).png>)
...
<table><thead><tr><th width="100">Icon</th><th width="170">Status</th><th>Description</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/image (846).png" alt=""></td><td>Running</td><td>Currently in execution</td></tr><tr><td><img src="../../../.gitbook/assets/image (822).png" alt=""></td><td>Enabled</td><td>Ready to be executed</td></tr><tr><td><img src="../../../.gitbook/assets/image (833).png" alt=""></td><td>Disabled</td><td>It will not be excuted at the defined scheduling</td></tr><tr><td><img src="../../../.gitbook/assets/image (555).png" alt=""></td><td>Expired</td><td>It is expired because the end date has been reached</td></tr><tr><td><img src="../../../.gitbook/assets/image (1043).png" alt=""></td><td>Error</td><td>The last execution raised an error</td></tr><tr><td><img src="../../../.gitbook/assets/image (1248).png" alt=""></td><td>Unkown Status</td><td>System failed to recover the status of the scheduling</td></tr></tbody></table>
...
The pencil icon![](<../../../.gitbook/assets/image (1308).png>) shows the fields that can be modifed. Once you click the enter button, the new value is saved.
