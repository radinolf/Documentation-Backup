...
In the snippet we have 2 parameters ( `par1, par2`) where the first three parameters are passed the names of some States. This snippet will pass its parameters to snippet 8348
...
{% code overflow="wrap" %}
```http
https://<application url>/api/rest/application/J3FFGSC/program/programID/body?key1={{par1}}&key2={{par2}}
```
{% endcode %}
...
<table><thead><tr><th width="336">KEY</th><th width="157.33333333333331">VALUE</th></tr></thead><tbody><tr><td>par1</td><td>Texas</td></tr><tr><td>par2</td><td>California</td></tr></tbody></table>
{% endtab %}
