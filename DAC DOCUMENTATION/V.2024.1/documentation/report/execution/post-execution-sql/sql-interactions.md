...
* **metric-decimal-digits:**  define decimal precision for metrics in SQL reports. If unset, the system falls back to the [`decimalPosition` ](../../../data-mapping/metrics/)of metric properties in the application, ensuring greater formatting control.
