...
View : How to create a decorated metrics in Design Studio [#format-with-decoration](../../data-mapping/metrics/#format-with-decoration "mention").
...
The graphic presentation of the links may be an image, for example ![](<../../../.gitbook/assets/1 (20).png>) . The image is selected by the administrator.
