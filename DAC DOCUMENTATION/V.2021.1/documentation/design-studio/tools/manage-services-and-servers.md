...
Some DAC-DS services require a connection to external servers to be able to be executed, for example, sending notifications (see [Notification Designer](../application/notification-designer.md))
