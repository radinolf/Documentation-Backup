...
Note: -_Cells with text wrap option have the_ ![](<../../../../.gitbook/assets/4 (10).png>) _Button. You can remove this option by first selecting the cell and then clicking the wrap text button._![](../../../../.gitbook/assets/5.png)_._
...
* On the [rows](/broken/pages/-MjDkGwZidV9HcsuKFJ2#table-rows-row-group)
...
The ![](../../../../.gitbook/assets/9.png) symbol indicates that the property has been set in _override_. To change them, just open the application properties and deselect override .
