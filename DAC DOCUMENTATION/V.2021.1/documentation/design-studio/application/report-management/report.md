...
The customization of report properties can take place, not only from the _Editing Report_ window, but also from the _Report Properties_ window which can be opened with the ![](<../../../../.gitbook/assets/1 (14).png>) Button.
...
The Metrics element ![](<../../../../.gitbook/assets/11 (7).png>) groups the metrics. These are initially placed in columns. Later they can be moved through drag & drop operations like those for dimensional levels.
...
* ![](<../../../../.gitbook/assets/12 (8).png>)the execution of the report
...
![](<../../../../.gitbook/assets/14 (6).png>)The SQL code generated by DAC and executed in DataWarehouse is displayed in the _**Query Viewer**_ window, opened using one of the buttons of the _Editing Report_ window.
...
The two arrows ![](<../../../../.gitbook/assets/28 (2).png>) at the beginning of the separation line are used to hide the graph (top arrow) or the table (bottom arrow).![](<../../../../.gitbook/assets/29 (3).png>)![](<../../../../.gitbook/assets/30 (3).png>)![](<../../../../.gitbook/assets/31 (1).png>)
...
![](/broken/files/-MedaJQofDvaL7oLGsaV)
...
![](<../../../../.gitbook/assets/53 (1).png>) ![](<../../../../.gitbook/assets/54 (1).png>)
...
* in the upper pane, you define the [connection to the data source](/broken/pages/-MfHyDAACqZ8KGz7lYEL#_Connessione_al_data)
...
![SNAGHTML937592](<../../../../.gitbook/assets/69 (2).png>)
...
Step 2: **Metrics Mapping**![](<../../../../.gitbook/assets/70 (1).png>)
...
Example - How to use the editable report into the Smart Grid Widget [View!](../../page-designer.md#example-how-to-use-the-editable-report-into-the-smart-grid-widget)
