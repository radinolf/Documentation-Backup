...
* [the aliases for the metrics and the levels used](other-detailed-properties-of-reports.md#parametric-aliases) by the report
...
* starting [a](/broken/pages/-MjE95PeRg5AqHCpE5Xs#_Avvio_di_un) [custom program](other-detailed-properties-of-reports.md#table-write)
...
* defining SQL [interactions](other-detailed-properties-of-reports.md#accessing-reports-from-external-systems-section) with the report
...
When the parameters are entered in the prompts of your report, the **Init** and **Default** buttons are enabled. These allow you to save, respectively, the values entered as default or initialize the values to those defined as default. For details see Report parameter prompts section
