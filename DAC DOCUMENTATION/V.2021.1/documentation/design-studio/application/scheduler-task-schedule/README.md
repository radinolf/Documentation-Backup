---
description: >-
  Use the Scheduler module to plan the updating and executing of certain logical
  objects based on a schedule, which was previously defined with the Schedules
  Designer module.
---
