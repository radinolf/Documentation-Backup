---
description: >-
  Resources that refer to files, images and CSS, that can be used by other DAC
  modules, can be “loaded” into the application.
---
...
Use the **New** button to open a window with access to the local folders. This is where you can select the file and generate a resource.![](<../../../.gitbook/assets/0 (21).png>)
