...
* [Enabling the report and Page](properties.md#generic-enabling-the-report-and-page) catalog, in DAC (_Generic_)
* the standard setting for [reports ](properties.md#report-properties-of-reports)and Metrics
* the[ configuration of the Pages](properties.md#page-properties-of-pages)
* [cache](properties.md#cache-properties-of-cache) management at application level
