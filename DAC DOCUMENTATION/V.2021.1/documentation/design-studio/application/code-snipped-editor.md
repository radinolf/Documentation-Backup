...
[http://\[HOST\]:\[PORT\]/\[DECISYON](file:///C:/) **WEB]/cassiopeaWeb/misc/http/httpReceiver.jsp.cas**?
...
![\\\fserver\projects\Manuali e training\Manuali\AppData\lrubino\AppData\Local\Temp\SNAGHTML768547.PNG](<../../../.gitbook/assets/0 (5).png>)
...
The command button ![](<../../../.gitbook/assets/4 (1).png>) allows you to restore Eclipse default configurations (such as Java or DAC libraries)

By clicking the ![](<../../../.gitbook/assets/5 (1).png>) button, you can restore the initial Workspace situation, deleting any files and folders, and leaving the Java class associated with the _Code Snippet_ unchanged.
