...
The data transfer process provides tools for tracking the operations performed in relation to the entries or modifications made in the target Cubes or to failed entries.

To define a data transfer, access the **DLR Designer** module from the **Application** menu item.

![](<../../../.gitbook/assets/0 (30).png>)

Use the ![](<../../../.gitbook/assets/1 (31).png>) button to select the _**SOURCE REPORT**_.

Use the ![](<../../../.gitbook/assets/2 (30).png>) button to select the _**SOURCE CUBE**_.

Use the ![](<../../../.gitbook/assets/3 (29).png>) button to select the _**TARGET CUBE**_ (next to the name of the cube chosen, the name of the related fact table is reported).
...
* [DELETE APPEND](/broken/pages/-MjTNXjnwPHcZLMAYWdz#_RDT_in_DELETE_1) preventive cancelation of the events to be updated and subsequent entry
...
* set the events to be UPDATED using the same modes defined for the update DLRs;
...
* Set the events to be ENTERED with the same modes defined for the entry DLR; the flag UPDATE and the section of the key fields are ignored
