...
* Data Visualization: set of widgets to visualize the data
* Form: set of widgets used to insert a text or select page by
* Button: set of widgets used to perform the operations which interact with other systems or other DAC objects
...
* Discussion: set of widgets use for discussions to be opened, possibly on a specific topic
* Resourc&#x65;**:** set of widgets to insert in the page image JavaScript or text
* Social Spaces: set of widgets used in the social space.

## Data Visualization

Data presentation widget to display the reports created in the application using:

* a table, with the Crosstab component
* a Chart
* an **Indicator**
* a Map
* a Tag Cloud
...
The page defined for the drill-through is displayed in a new window, opened from the _**Detail>>**_ (in the information window associated with the marker).![](<../../.gitbook/assets/3 (16).png>)![](<../../.gitbook/assets/4 (16).png>)
...
#### Example: Gauge-Start-Angle and Gauge-End-Angle![](<../../.gitbook/assets/10 (13).png>)![](<../../.gitbook/assets/11 (12).png>)![](<../../.gitbook/assets/12 (11).png>)![](<../../.gitbook/assets/13 (12).png>)
...
In the _Attachments_ section, you can either select a report from the ![](<../../.gitbook/assets/78 (3).png>) button or a Page by selecting the.![](<../../.gitbook/assets/79 (3).png>) button.
...
_The Text object will display the_ ![](<../../.gitbook/assets/115 (3).png>)_icon from which a second image can be accessed, that will display the detailed information on the bubble graph._
...
_The second link displays the icon_ ![](<../../.gitbook/assets/116 (2).png>)_((\<img src="../../customizations/img/1297265268\_info.png" border="0" alt="Info Bubble Graph">)_
