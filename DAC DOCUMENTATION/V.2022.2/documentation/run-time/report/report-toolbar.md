...
### Report Toolbar <a href="#toc34301088" id="toc34301088"></a>
...
_**Compatibility issue**: if you are using version 9.4.2 or 9.4.3 of_ Adobe Acrobat Reade&#x72;_, immediate printing is not permitted. Instead, you will be prompted to save the report as a file. Only after saving will you be able to open and print it._
...
The toolbar of the report can be hidden using the ![](<../../../.gitbook/assets/4 (1)>) button and reopened with the ![](<../../../.gitbook/assets/5 (2)>) button.

In the hidden form, the commands for printing and exporting (to PDF, Excel and CSV) remain available.

![](<../../../.gitbook/assets/6 (2)>)

The publication of the reports may be configured by the administrator directly with the hidden toolbar, which will be enabled from the toolbar open button ![](<../../../.gitbook/assets/7 (4)>).

Some configurations also include publication without the toolbar; in these instances, the Open button will be absent.

#### Type of Report Presentation <a href="#toc34301089" id="toc34301089"></a>
...
#### Show Report Items <a href="#toc498423771" id="toc498423771"></a>
...
**Note**_**:**_ The commands for deleting and editing cannot be accessed on Tablet devices.
