...
Selecting the box ![](<../../../.gitbook/assets/2 (11)>) (see figure) applies the changes you made, and disables the formatting bar again. To make the changes effective, just save the report.
