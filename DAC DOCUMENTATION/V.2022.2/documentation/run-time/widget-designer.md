...
* [DAC Widegt Hub (folder)](widget-designer.md#hub-folder)
* [DAC Widget Hub (button)](widget-designer.md#install)
...
**Published:** Whether the widget is published or not. When published it shows the icon ![](<../../.gitbook/assets/3 (8)>)
...
* **Clone:** Create a copy of the selected widget.
  ...
  * **Show dependencies:** Show the dependencies of the widget to the other components
...
* **Publish/Unpublish:** Publish/Unpublish the widget to make it available or not  in the Page Designer Widgets
* **Export:** Export the Widget
* **Delete:** Permanently delete the widget from the folder
* [**Show Dependencies:**](widget-designer.md#dependence-widget) To know the dependencies of the widget within your application
...
![https://gblobscdn.gitbook.com/assets%2Fpothole%2F-Me4UcB3LybUNCnFdfgt%2F-Me4W9R6Zyo\_PWsTYtV5%2F7.jpeg?alt=media](<../../.gitbook/assets/15 (3)>)
...
* Page Integration : In this section you can hide the properties not needed by the widget. Once disabled, these properties are not displayed in the DS when configuring the widget on pages.
...
Below the code that we are going to insert in the configuration.json of the widge.
...
Access the Page Desiigner and insert in the page the widget you created in step 1 and a widget Execute Button. The new property is present in the folder Object .
