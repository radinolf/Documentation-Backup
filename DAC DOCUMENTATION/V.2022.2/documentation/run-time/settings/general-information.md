...
It s necessary to add environment variable also on DAC-DS Operative Sytem to use variable on DAC-DS.

{% hint style="info" %}
It is very important to point out that the environment variables have a different syntax depending where are declared:
...
You can download the Design Studio installer from RunTime. You need to have an active user account in DAC with “administrator” grant in order to download the installer. If you don’t have it, please ask to your system administrator.
...
Please see the documentation [Design Studio Installer](../../design-studio/design-studio-installer.md).
