---
description: >-
  In the applicatio management function you can execute the deployment of the
...
* From the wizard, select the Deploy on File and enter the Metadata file (metadata\_app\_file.ctr). The system will perform a control procedure on both the objects and the metadata versioning because they need to be the same on both applications.

![](https://dac-docs.s3-us-west-1.amazonaws.com/ImgSito/Deploy/8.jpg)
