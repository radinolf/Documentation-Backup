...
To define the condition you need to click the ![](../../../.gitbook/assets/3.png) button which opens a different window, according to the type of object selected in the _alertType_ property:
...
![Descrizione: SNAGHTML692740](<../../../.gitbook/assets/5 (23).png>)
...
To define the condition you need to click the ![](<../../../.gitbook/assets/7 (17).png>) button which opens a window to insert a single condition.
...
The ![](<../../../.gitbook/assets/16 (7).png>) button starts the wizard to test the rule.

![SNAGHTML6bdd0ab8](<../../../.gitbook/assets/17 (10).png>)
