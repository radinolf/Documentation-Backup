...
Please see the Example How to configure the Editable Report ([Page Designer](/broken/pages/-MhIPCzeRKVk_czjJXrf#example-how-to-use-the-editable-report-into-the-smart-grid-widget) molue)
