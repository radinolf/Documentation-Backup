...
* when you use the **column container** widget with `flex-container` enabled, the **main axis is “row”** and the widgets are laid out from left to right.&#x20;
* when you use the **row container** widget with with `flex-container` enabled, the **main axis is “column”** and the widgets are laid out from top to bottom.&#x20;
...
* horizontal-align: set the horizontal alignment of the widget in the flex container. Possible values: left, center, right or empty. When empty, the “left” alignment is applied.
* vertical-align: set the vertical alignment of thw widget in the flex container. Possible values: top, center, bottom or empty. When empty, the “top” vertical alignment is applied.
