...
Let us remember that these are the tables used in the mapping of the **cubes**. The **measures** necessary for the analysis are defined in the cubes (_see_ _Cubes and measures_ chap.).![](<../../../.gitbook/assets/0 (19).png>)
...
**Data Model >> Metrics Management** or from the![](<../../../.gitbook/assets/1 (25).png>) button on the main bar.
...
![](<../../../.gitbook/assets/10 (25).png>)![](<../../../.gitbook/assets/11 (12).png>)
...
![](<../../../.gitbook/assets/23 (6).png>)_You select the background color to be attributed to the bar. The 200 target provides you with a good resolution for comparing the bars with each other. The Metric on DAC is shown at the bottom._
...
_Choose the graphical form (_![](<../../../.gitbook/assets/28 (5).png>) _button): In the graph leave only the part reserved to the trend, without axes and key:_
...
![](<../../../.gitbook/assets/44 (8).png>)

_Create a new advanced metric (Qty For Week), inside the Sales cube folder, which calculates the quantity sold by week._

_Dimensioning by week is performed by accessing the Dimensions panel through the_ ![](<../../../.gitbook/assets/45 (1).png>) _button and selecting the Week level from the Sales cube._
...
![SNAGHTML5d61e2](<../../../.gitbook/assets/54 (5).png>)
...
By selecting the ![](<../../../.gitbook/assets/55 (1).png>) button located on the main screen to the right of the defined filter, the system shows the Properties window which makes the metric inherit the filters available in the report where it will be used (check on the _Inherit filters_ item).
...
![SNAGHTML5e2be9](<../../../.gitbook/assets/56 (7).png>)
...
![SNAGHTML72b9df](<../../../.gitbook/assets/65 (3).png>)
...
To access the _**Metric functions**_ window, press the ![](<../../../.gitbook/assets/69 (5).png>) button.
...
![](<../../../.gitbook/assets/74 (3).png>)

_Create the first metric called Order Qty Partition._

_Through the_ ![](<../../../.gitbook/assets/75 (4).png>)_button, access the window of the Metric Functions and select Sum function from the basic folder._
...
![SNAGHTMLc1a1a4](<../../../.gitbook/assets/87 (3).png>)
...
| ![](<../../../.gitbook/assets/101 (4).png>) | **Level** |
| ------------------------------------------- | --------- |
...
![SNAGHTML70d159](<../../../.gitbook/assets/137 (2).png>)

Step 3: **Publishing Metrics**

![](<../../../.gitbook/assets/138 (1).png>)
