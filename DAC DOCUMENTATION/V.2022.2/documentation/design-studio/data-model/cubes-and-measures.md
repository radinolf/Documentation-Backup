...
![SNAGHTML18d4897](<../../../.gitbook/assets/3 (24).png>)
...
To start the user filter wizard: from the menu bar, select **Data Model** and **User filter management**; otherwise from the tool bar, select the ![](<../../../.gitbook/assets/19 (6).png>) button.
