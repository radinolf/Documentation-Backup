...
DAC also defines the filters exclusively used by the single report (see _Report Administrator, chap., Report, Exclusive Filters section._)
...
**Data Model>>**>>**Direct Filters management**, or the ![](<../../../.gitbook/assets/0 (24).png>) button on the tool bar.
...
![](<../../../.gitbook/assets/12 (19).png>)![](<../../../.gitbook/assets/13 (13).png>)
...
or from the toolbar, using the ![](<../../../.gitbook/assets/16 (12).png>) button.
