...
For more detail See the [Page Layout](../documentation/design-studio/page-designer/page-layout/)
...
{% content-ref url="../documentation/run-time/administration/jobs/" %}
[jobs](../documentation/run-time/administration/jobs/)
{% endcontent-ref %}
...
View Page Designer >>Activities Task >> [Accessing Page from External Systems](../documentation/design-studio/page-designer/advanced-configuration/activities-task.md#accessing-page-from-external-systems)
