...
* Automatic transcription of meeting discussions
* Capture of key decisions and action items during the meeting
* Structured minutes output for easy review and sharing
* Real-time note-taking and content organization

🧩 **Ideal Use Cases**

* Corporate meetings where accurate record-keeping is essential
* Project management teams that need a clear list of action items and decisions
* Remote teams that require automatic meeting documentation
* Team collaborations to ensure key points and tasks are not missed

Executive and leadership meetings for easy tracking of high-level decisions<br>

## Version 2025.0.0

### **Taskboard & Teams** <a href="#taskboard-and-teams" id="taskboard-and-teams"></a>

The Taskboard is a new feature designed to enhance task management and assignment within organizations. With the introduction of Teams, tasks can be assigned to structured user groups, ensuring more efficient and collaborative management.

<figure><img src="https://lh7-rt.googleusercontent.com/slidesz/AGV_vUe1XwxGP_m08lZsRr5JA4gSF-7vh_0b-4nTikvk7ZMMIg_XnYMiwyh_TJ1DKmKc0oaopAlIqspFQIgLzxhiV7L8DKj-kNP1yMlSaoc8phVufZz10NKeLEZX8UA3w4m2xtuxyK28jxpYeAzJ79FTaYY=s2048?key=c4-6ArWOHtrkwwo3YQsfbmsB" alt=""><figcaption></figcaption></figure>

A flexible solution for task management within organizations, enabling dynamic assignment to users and teams.

* **Flexible Assignment:** Tasks can be assigned to individual users or entire Teams.
* **Dynamic Management :** Tasks can move freely between states
* **Archiving:** Completed or irrelevant tasks can be archived and restored.
* **Teams:** Created within an organization, include users from the same organization, helping to better segregate and assign tasks.
* **Flexible Deployment**: enable or disable tasks during the deployment of App Composer.
* **File Management:** allows to upload external file to enrich the context. Files are persisted in a dedicated blob storage, easy to access and to use.

### Team

<img src="https://lh7-rt.googleusercontent.com/slidesz/AGV_vUf0OTddSjtua5DxjFNSuhqKYVjiUbDdh1Rxo5WDzK4qvyD8O1IlWWPfazT2g84WHis-EBaNJR9G3cLAZHZvN4DOjYnStAaBkTZhfUnHWv8QLXSGVmVzOY2wpESf3-ta0kkIYCxD6QxPDXbwaW_JfhQ=s2048?key=c4-6ArWOHtrkwwo3YQsfbmsB" alt="" data-size="line"> The new **Team** feature adds greater flexibility to task management. Each Team functions as a clearly defined group of users, designed to boost collaboration and simplify task workflows. With Teams, tasks can be assigned at both the individual and team levels—promoting better coordination, consistency, and control, especially for activities that require flexible assignment options.

* **Organizational Scalability**: Multiple Teams can be created within the same Organization.
* **Flexible Membership:** Users can belong to one or more Teams at the same time.
* **Feature-Dependent Visibility:** Teams are visible and usable only when the “Task functionality” is enabled for the Organization.
* **Structured Assignment:** Tasks can be assigned either to an entire Team or to a specific user within that Team.
* **Centralized Management:** Teams are managed by Organization administrators who can create, rename, and delete Teams.
* **Clear Ownership:** Each Team is strictly linked to its Organization and cannot span across multiple Organizations.

<figure><img src="https://lh7-rt.googleusercontent.com/slidesz/AGV_vUcxnEn4g4p8wJH-fwgba_ngRZQYVGmIO8StgljMUIB1HWG-__kGlx5CuiYPKNQvtyBBiJ8VSLDSGldyrKcDmo0fDZ9a92oX7CgfG59GzoQVnHrPw6-oJKXQdxWDYP-2o3z7I89wz83T_8XraZGk-g=s2048?key=c4-6ArWOHtrkwwo3YQsfbmsB" alt=""><figcaption></figcaption></figure>

**Developments introduced a New FeaturesMicrosoft Edge**

### **Microsoft Edge**

<img src="https://lh7-rt.googleusercontent.com/slidesz/AGV_vUdy9kfsp05oIgeGOYVKN9tp1Hm7eoXUcRUxRCS4uFTCLlyToIT0BvSu0yZTX9Rvx-BKUn3c6E3BEi7CTVV2hDilRyCqEnfrIJ7B8V-rsmpP5_zMRoex5qyln4cc82xjP7hy_aU2izgVmW1wJjas4Q=s2048?key=c4-6ArWOHtrkwwo3YQsfbmsB" alt="" data-size="line">Officially introduces support for Microsoft Edge, expanding the platform's compatibility with the most commonly used browsers in enterprise environments.&#x20;

### **Increased Performance**

<img src="https://lh7-rt.googleusercontent.com/slidesz/AGV_vUeQTuxtdvDiVf6h-VsoVsT5epyHN1-bcINnIKNxCzT3EsRqEEMrZzJIevvCC21Uz0p6nch9fSwDHce4pylWjKL_NVnWfejPK0wRJE8W6HOcGAgHHo42v-_TxO5xrguGc-G_yMJ-JSbapfPeCN8tcg=s2048?key=c4-6ArWOHtrkwwo3YQsfbmsB" alt="" data-size="line">The execution performance of reports associated to widgets has been significantly improved—**over 50%**—resulting in a noticeable reduction in loading time of the page.

### **Cyber Security**

<img src="https://lh7-rt.googleusercontent.com/slidesz/AGV_vUfT3rUqbae1I8F_r5ENvxoo2rJorlSliY7CkhITKeTWc7J6VzXDXV0SNXyyX3K3FvtLoBZVheh7rURJnowhX_gtEja4zmEcR7fW9ICsZdspbmraAfscZl6FDHp1fi9wo6-xHbd2bYG-qwbQdyRIux4=s2048?key=c4-6ArWOHtrkwwo3YQsfbmsB" alt="" data-size="line"> Several CVE related to vulnerabilities and cybersecurity improvements/fixes have been included, strengthening the overall protection of the platform.

<br>

## Version 2024.1.0

Decisyon App Composer 2024.1.0 is a significant milestone in the evolution of App Composer. This major release introduces several key features and enhancements:

1. **Modular Architecture**: enhanced flexibility and scalability tailored to specific architecture and environments.
2. **Technological Upgrades:** cutting-edge technology and security updates to support a wider range of applications and requirements.
3. **Enhancements**: dozens of improvements that optimize the development process

### Modular Architecture

In the new architecture, the services adapt based on several criteria:

* Development vs. Production Environment
* No Tenant vs. Multitenant&#x20;
* Business User vs. Application Developer

In a development environment, you can now deploy only the services required for application development, with appropriate resources. In a production environment, you can now deploy only the necessary services to run the application, ensuring correct resource allocation.&#x20;

With this approach and several new features, Design Studio is no longer needed to operate in a production environment.

For more details please visit the documentation.

{% content-ref url="../documentation/introduction/architecture/" %}
[architecture](../documentation/introduction/architecture/)
{% endcontent-ref %}

### New Microservice

App Composer 2024.1.0 introduces new microservices designed to better segregate features for business users and app developers, while also supporting multitenancy. The new microservices include:

**Pages**:  is the microservice that serves applications built by App Developers. It offers business users the features and functions of the business applications.

<figure><img src="../.gitbook/assets/image (2162).png" alt=""><figcaption></figcaption></figure>

{% content-ref url="../documentation/introduction/application/pages.md" %}
[pages.md](../documentation/introduction/application/pages.md)
{% endcontent-ref %}

**Cockpit**: is a new microservice responsible for managing and monitoring applications in **production environments**, where App Composer and Design Studio are no longer available.

<figure><img src="../.gitbook/assets/image (2164).png" alt=""><figcaption></figcaption></figure>

{% content-ref url="../documentation/introduction/application/cockpit/" %}
[cockpit](../documentation/introduction/application/cockpit/)
{% endcontent-ref %}

**App Composer** : is the **current microservice** you are used to, but it mainly changes its role, becoming a tool for application development only.

<figure><img src="../.gitbook/assets/image (2158).png" alt=""><figcaption></figcaption></figure>

{% content-ref url="../documentation/introduction/application/appcomposer/" %}
[appcomposer](../documentation/introduction/application/appcomposer/)
{% endcontent-ref %}

### Multi-Tenancy&#x20;

App Composer now supports a new multi-tenant architecture using the "Shared Appplication, Separate Database" model:

<figure><img src="https://lh7-us.googleusercontent.com/slidesz/AGV_vUfzIPEaKv4enLloL85gW7nxY-YjqiC703fodOqAYMlTCwdAoA6bRxbfQyfomMCiCs1qXGhJ531pvTPfDKf6xSXJH7DbClcirltLg-uS4D6KVVREEuJa_JYXt57-rNQvu9UunV3pYg0SD4tf5fn0toE_F0FlzTWiRlej2VxQ1pzo=s2048?key=jfKuFeo1YEEgtCA4dkwdWw" alt=""><figcaption></figcaption></figure>



* One App Composer application stack could serve multiple tenants.
* Each “tenant” could be a customer, a plant, etc.
* Each tenant's specific data is segregated into its own database, ensuring data isolation and security
* App Composer handles user-tenant associations seamlessly.
* Upon login, users are automatically directed to their respective tenant-specific data sources.
* Dedicated services handle the provisioning of new tenants efficiently.
* Infrastructure changes are determined by the chosen architecture, whether No-Tenant or multi-tenant.
...
Now users are automatically created at the time of login in Pages. This automation has simplified the user management process, allowing us to eliminate the "User Administration" section previously present in AppComposer.

### Grant access to app developer on AppComposer

With the removal of the "User Administration" section from the App Composer service, administrators must now be added to the whitelist for access to App Composer. Administrators not included in the whitelist will be denied login. If they are included in the whitelist, their user accounts will be automatically created upon login.

The whitelist is a new property that must be specified in the HELM Chart for deploying App Composer and Pages.

Please see the Migration Note Documentation.

{% content-ref url="untitled/version-2024.1.0/migration-notes.md" %}
[migration-notes.md](untitled/version-2024.1.0/migration-notes.md)
{% endcontent-ref %}

### From “Tenant” to “Organization”

In the context of extending our multitenant architecture, we've decided to rename the existing feature previously known as "tenant" to "organization." This change is aimed at preventing confusion and better reflecting the feature's true purpose: to segregate data internally within each tenant.

<figure><img src="../.gitbook/assets/image (2117).png" alt=""><figcaption></figcaption></figure>

With the introduction of new multitenancy, the term "tenant" could lead to misunderstandings.

The term "organization" more accurately describes the feature’s role in data segregation within each tenant.

{% hint style="warning" %}
**Warning**: This renaming will introduce breaking changes. Please refer to the migration note document for more details.
{% endhint %}
...
To align with the renaming of **Tenants** to **Organizations**, the User Scopes have also undergone a transformation. In this version, both the S**copes** and their types have been **renamed** to **User Scopes** and **Scope Type**, respectively.&#x20;

The table below highlights the correspondence between the values from the previous version and the current one.

<table data-full-width="false"><thead><tr><th width="330">Before 2024.1.0 - Legacy scope name</th><th width="136"></th><th>From 2024.1.0 - New scope name</th></tr></thead><tbody><tr><td>None</td><td>Renamed to</td><td>None</td></tr><tr><td>Users administration</td><td>Renamed to</td><td>Users administration</td></tr><tr><td>Tenants Administrator</td><td>Renamed to</td><td>Organizations administration</td></tr><tr><td><p>All Tenants </p><p>Administrator</p></td><td>Renamed to</td><td>All organizations administration</td></tr></tbody></table>

In the JSON schema generated by the API to create a new user, the following changes have been made. In the previous version, the user's scopes were contained in the variable named 'Scopes'. Now, the user's scopes are contained in the variable 'UserScope'. In the table below, you can see the previous and new variable names along with their values. Plese see the [Migration Notes](untitled/version-2024.1.0/migration-notes.md).

| Previous Versions | 2024.1.0    | Values                                         |
| ----------------- | ----------- | ---------------------------------------------- |
| Scoopes           | User Scope  | <p>U_ADMIN</p><p>T_ADMIN</p><p>ALL_T_ADMIN</p> |

### OpenID Connect - Auth services

App Composer is now compatible with any OpenID Connect provider, such as Google, GitHub, Ping Identity, OAuth0 etc.&#x20;

Before this version, it was required to use Keycloak to achieve the same functionality. Starting from 2024.1.0, the identify provider can be configured directly in App Composer.&#x20;

{% hint style="warning" %}
**Warning:** If you are using Keycloak, you can keep using it as in the previous version, but there is  a migration note to consider when deploying App Composer
{% endhint %}

### UI and UX&#x20;

After collecting feedback from users and partners, 2024.1.0 aims to address key pain points from a UI and UX perspective, enhancing navigation, context awareness, and overall usability.

In this new version, we have significantly improved the performance of the DAC. We have optimized page loading times, making navigation much faster and more efficient. This change will allow you to access the software's content and features more quickly.

<figure><img src="../.gitbook/assets/image (2152).png" alt=""><figcaption><p>Pages UI</p></figcaption></figure>

[**Pages**](../documentation/introduction/application/pages.md)**,** designed for business users, offers a highly intuitive interface focused exclusively on the applications and pages accessible to the user. Additionally, administrator users will have access to the User Administration section, making management even simpler and more immediate.

* [**Home Page and Navigation**](whats-new-in-this-version.md#home-page-and-navigation)**:** Pages interface allows business users to easily navigate through application pages, facilitating efficient content exploration.
* [**User Profile Section**](../documentation/user-management/user-profile-in-pages.md)**:** Users can customize their profiles and meet individual preferences using the **Profile** interface.
* [**User Management**](../documentation/user-management/user-administration/)**:** Includes features for managing user accounts, organizations and editing settings.

### Navigational path

<figure><img src="../.gitbook/assets/image (2153).png" alt=""><figcaption></figcaption></figure>

Now the breadcrumb, in addition to showing the page you have accessed, also displays the complete path, starting from the application and including the relevant subfolder

### Full Screen

It’s now possible to easily go in full screen on a page.&#x20;

Nella visualizzazione in fullscreen si mette in primo piano il contenuto della pagina e vinene nascosto il navigation panel&#x20;

<figure><img src="../.gitbook/assets/image (2157).png" alt=""><figcaption></figcaption></figure>

### User Profile

Now the User Profile, with a renewed layout and better organization, makes it even easier to access information related to your account. User information is divided into specific categories:

<figure><img src="../.gitbook/assets/image (2141).png" alt=""><figcaption></figcaption></figure>

* **General information**: Here you will find all the details related to your connected account. This information is passed to the DAC through the identity provider's claim.
* **Settings**: In this section, you can configure all the information related to language, time zone, and select the default organization.
* **Scopes and groups**: You can view both the scopes and the groups to which you belong.
* **Security**: This section introduces important new features. You can view the list of tokens generated for your user and, if they are no longer used, delete them. The Token column shows part of the identification code so you can trace the specific token. The scopes column also shows the scope for which the token was generated.

<figure><img src="../.gitbook/assets/image (2142).png" alt=""><figcaption></figcaption></figure>

This new organization of the user profile makes it easier and more intuitive to manage all the important information of your account.Ora in Pages è presente una nuova User Profile con un nuovo e una nuova organizzazione delle informazioni relative all'utente. Le iinformazioni dell'utente sono suddivise in categorie nello specifico:

### Synchronization&#x20;

It’s now possible to synchronize **Terms of Use** and **User Attributes** from the source to the target environment.

Moreover the name of the imported ADP file during synchronization it’s now visible in the UI.

### &#x20;HELM chart

To accommodate the numerous infrastructure and architectural changes, a new HELM chart has been defined and is easier to configure.

{% hint style="warning" %}
**Warning:** There are breaking changes in the HELM chart. The `values.yaml` file from previous versions of App Composer is not compatible. Refer to the migration note document for details.
{% endhint %}
...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](<../.gitbook/assets/image (1499).png>)                              | ![](<../.gitbook/assets/image (833).png>)                                                                                                                                     | ![](<../.gitbook/assets/image (643).png>)                                                                                                     |
...
View Page Designer >>Activities Task >> [Accessing Page from External Systems](/broken/pages/fuemvKzPgpKzze1wNmeg#accessing-page-from-external-systems)
...
* In the User Administration section, the edit of a user from Dx-Sidenav has been moved to the dialog box. See the figure.. (See [Users Administration](/broken/pages/-MfHjoHakJFOYNcJQCmo#create-new-user) for details)
...
See [Server\&Services](/broken/pages/-Mjcfc-EaiKt0AyAaMFz)
...
{% content-ref url="/broken/pages/-MfHjoHakJFOYNcJQCmo" %}
[Broken link](/broken/pages/-MfHjoHakJFOYNcJQCmo)
{% endcontent-ref %}
...
{% content-ref url="/broken/pages/-MfHjxCkkcCQor57m7-H" %}
[Broken link](/broken/pages/-MfHjxCkkcCQor57m7-H)
{% endcontent-ref %}
