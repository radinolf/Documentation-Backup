...
Use the  button to open a window to define the document editing privileges and publishing modes.
...
* **Specific users:** allows other users to edit and publish content, in addition to the author.
  * When you select this item, you enable a field for adding users.
* **Anyone :** users who have visibility for the content can edit and publish it.
