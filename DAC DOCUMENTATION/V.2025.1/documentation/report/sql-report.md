...
![](<../../.gitbook/assets/53 (8).png>) ![](<../../.gitbook/assets/54 (6).png>)
...
If the table contains both the key and the description fields, you define their association in the pop-up box, opened by clicking the ![](../../.gitbook/assets/65.png) button:
...
Step 2: **Metrics Mapping**![](<../../.gitbook/assets/70 (3).png>)
