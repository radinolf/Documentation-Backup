...
To access this section click the Users button <img src="../../../.gitbook/assets/image (139).png" alt="" data-size="line"> located in the **Main Toolbar** of Pages.
...
2.  **Filter** **Button**![](<../../../.gitbook/assets/image (149).png>): Located in the Search field, it allows you to filter the list based on specific criteria:
...
* **Delete users** <img src="../../../.gitbook/assets/image (110).png" alt="" data-size="line">:  Remove selected users.
* **Disconnect users** <img src="../../../.gitbook/assets/image (111).png" alt="" data-size="line">: Log out selected users.
* **Enable users** <img src="../../../.gitbook/assets/image (98).png" alt="" data-size="line">:  Activate selected users.
* **Disable users**<img src="../../../.gitbook/assets/image (100).png" alt="" data-size="line">: Deactivate selected users.
...
* ![](<../../../.gitbook/assets/image (157).png>)**Search** **Field**: Search for the organization in the list.
* ![](<../../../.gitbook/assets/image (158).png>)**Create Organization Button**: Create a new organization.
