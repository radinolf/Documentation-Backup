...
In this example we use the API that return the list of [Task](/broken/pages/-MfHgDqO0nKQQ-UqipQ6) visible to the user who make the request. In the figure below we can see the task opens in the Task Board. The API will be configured to return two tasks (`size=2`) with the status New (`status=0`).
...
<div data-full-width="true"><figure><img src="../../../../.gitbook/assets/image (2074).png" alt=""><figcaption></figcaption></figure></div>
...
* **predicate** : These parameters filter the API results based on all the fields set for the creation of the task, such as title, priority, and status etc. (For more details wee the [Task ](/broken/pages/vxO5J6uB8wne2EwEJO7m)documentation)
* **pageble**: Set the pagination value.

## **Step 2 - Configure the request in Postman**&#x20;

<div data-full-width="true"><figure><img src="../../../../.gitbook/assets/image (203).png" alt=""><figcaption></figcaption></figure></div>
...
<div data-full-width="true"><figure><img src="../../../../.gitbook/assets/image (202).png" alt=""><figcaption></figcaption></figure></div>
...
{% hint style="success" %}
In JSON file click on the title of the Task ![](<../../../../.gitbook/assets/image (193).png>)
{% endhint %}
...
[^1]: ![](<../../../../.gitbook/assets/image (192).png>)

[^2]: ![](<../../../../.gitbook/assets/image (194).png>)
