...
<figure><img src="../../../../.gitbook/assets/image (324).png" alt=""><figcaption><p>In this screenshot, we see a code snippet from App Composer being used as an endpoint. Additionally, the Bearer token corresponds to the currently logged-in user.</p></figcaption></figure>
