# Change and migraztion of Version 6.6.2
...
* **Decisyon App Composer for Docker** \
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.appcomposer-docker:MALCOM.2.RELEASE
* **Decisyon App Composer for Kubernetes**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.appcomposer-k8s:MALCOM.2.RELEASE
* **Cornelius Configuration Server**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.cornelius:MALCOM.2.RELEASE
* **Keycloak OIDC Server**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.keycloak:MALCOM.2.RELEASE
* **Gertrude Flowable Back-end**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.gertrude:MALCOM.2.RELEASE
* **Flowable Modeler**\
  decisyon-dac-docker-prod.jfrog.io/com.decisyon.flowable-modeler:MALCOM.2.RELEASE
* **Decisyon Design Studio**\
  http://repository.decisyon.com/public/dac-designstudio/release/malcom.2
