...
## Version 2022.1.2 (Patch) - 20 July 2022

### Enhancements Introduced

**This section of the Change Log provides a list of the new enhancements implemented in version 2022.1.2**

[D4C-7257](https://decisyon.atlassian.net/browse/D4C-7257) Reduce response time when Tab Panel and Tab Selector are used in the page

### Fixed Defects ​​

**This section of the Change Log provides a list of the defects solved.**

[D4C-7268](https://decisyon.atlassian.net/browse/D4C-7268) DECISYON.page.subscribeEvent doesn't work

[D4C-7267](https://decisyon.atlassian.net/browse/D4C-7267) Porting of D4C-7101 (Tab Panel loading icon) from Whitewater to Theobald.2

[D4C-7265](https://decisyon.atlassian.net/browse/D4C-7265) Java Error : Cannot invoke "it.unyversys.cassiopea.metadata.report.model.properties.ReportDebugModeProperty.getBoolValue()"

[D4C-7256](https://decisyon.atlassian.net/browse/D4C-7256) Decode special char in the report header section
...
<table data-header-hidden><thead><tr><th width="185"></th><th></th><th></th><th></th></tr></thead><tbody><tr><td><strong>DEPRECATION</strong></td><td><strong>IMPACT</strong></td><td><strong>ALTERNATIVE CONFIGURATION</strong></td><td><strong>FUNCTION GUARANTEED UNTIL VERSION</strong></td></tr><tr><td>Removal Java 11</td><td>Design Studio will no longer support java 11</td><td>The jdk will be managed directly by the new installer, therefore the user will not have to perform any operation.<br></td><td>2022.1.0</td></tr><tr><td>ext* Javascript function</td><td>Deprecate all ext* Javascript function accessible from the Page's Javascript object.</td><td>In the function panel, the new function is indicated for each deprecated function.</td><td><p>2023.0.0</p><p> </p></td></tr><tr><td><p>Widget SDK Api, leave Template and Target objects only.</p><p><br></p></td><td>All the Widget SDK documentation which refer to the global DECISYON object are deprecated and will be removed. Refer to the <a href="https://dac.decisyon.net/docs/widget_sdk/index.html#/api_decisyon/@Introduction">Decisyon API</a> documentation for next developments</td><td><p>The new documentation is available on the Decision API tab in the Widget Designer documentation.</p><p><br></p></td><td><p>2023.0.0</p><p><br></p></td></tr><tr><td>Widget <a href="https://decisyon.atlassian.net/wiki/spaces/~436823021/pages/2353496065/Change+Log+Version+2022.1.0+Theobald"><strong>Styled Selector</strong></a></td><td>It will no longer be possible to use the legacy widget "Styled Selector" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.</td><td><p>Several new widgets will be distributed via Widget Hub and it replace each "style" of the legacy widget. Existing widgets in pages must be manually migrated to the new widget.</p><p><br></p></td><td>2021.3.0</td></tr><tr><td>Widget<a href="https://decisyon.atlassian.net/wiki/spaces/~436823021/pages/2353496065/Change+Log+Version+2022.1.0+Theobald"> <strong>Inner Container</strong></a></td><td>It will no longer be possible to use the legacy widget "Inner Container" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.</td><td>A new widget will be distributed via Widget Hub. Existing widgets in pages must be manually migrated to the new widget.</td><td>2021.3.0</td></tr><tr><td>Widget <a href="https://decisyon.atlassian.net/wiki/spaces/~436823021/pages/2353496065/Change+Log+Version+2022.1.0+Theobald"><strong>Image</strong></a></td><td>It will no longer be possible to use the legacy widget "Image" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.</td><td>A new widget will be distributed via Widget Hub. Existing widgets in pages must be manually migrated to the new widget.</td><td>2021.3.0</td></tr><tr><td>Widget <a href="https://decisyon.atlassian.net/wiki/spaces/~436823021/pages/2353496065/Change+Log+Version+2022.1.0+Theobald">Map</a></td><td>It will no longer be possible to use the legacy widget "Map" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.</td><td><p>A new "map" widget will be distributed via WidgeHub. Existing widgets in pages must be manually migrated to the new widget.</p><p><br></p></td><td>2021.3.0</td></tr><tr><td>Widget <a href="https://decisyon.atlassian.net/wiki/spaces/~436823021/pages/2353496065/Change+Log+Version+2022.1.0+Theobald">Wizard</a></td><td>It will no longer be possible to use the legacy widget "Wizard" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.</td><td><p>A new widget will be distributed via Widget Hub. Existing widgets in pages must be manually migrated to the new widget.</p><p><br></p></td><td>2021.1.0</td></tr><tr><td>Widget<a href="https://app.gitbook.com/o/-Mf1nqOzbgLBl5PsDWsN/s/bhu84cM46ITfHln35pSX/documentation/design-studio/page-widget/form#file-selector-file-selection"> File Selector</a>​</td><td>It will no longer be possible to use the legacy widget "File Selector" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.</td><td><p>A new widget will be distributed via Widget Hub. Existing widgets in pages must be manually migrated to the new widget.</p><p><br></p></td><td>2021.3.0</td></tr><tr><td>Data Source XML</td><td>It will no longer be possible to use the data source "XML". In case the removal will affect features already available in a production environment please contact your account in Decisyon.</td><td>No alternative configuration will be provided.</td><td>2022.3.0</td></tr></tbody></table>
...
**This section of the Change Log provides a list of the new enhancements implemented in version 2022.1.1**
...
**This section of the Change Log provides a list of the new enhancements implemented in version 2022.1.0**
...
| Widget [**Styled Selector**](../../documentation/design-studio/page-widget/form.md#styled-selector-deprecated)                                                                                                                                                     | It will no longer be possible to use the legacy widget "Styled Selector" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.                                  | Several new widgets will be distributed via Widget Hub and it replace each "style" of the legacy widget. Existing widgets in pages must be manually migrated to the new widget.                                                                                                                                                    | 2022.2.0                              |
| Widget[ **Inner Container**](../../documentation/design-studio/page-widget/containers.md#inner-container-deprecated)                                                                                                                                               | It will no longer be possible to use the legacy widget "Inner Container" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.                                  | A new widget will be distributed via Widget Hub. Existing widgets in pages must be manually migrated to the new widget.                                                                                                                                                                                                            | 2022.2.0                              |
| Widget[ **Image**](../../documentation/design-studio/page-widget/resource.md#image-deprecated)                                                                                                                                                                     | It will no longer be possible to use the legacy widget "Image" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.                                            | A new widget will be distributed via Widget Hub. Existing widgets in pages must be manually migrated to the new widget.                                                                                                                                                                                                            | 2022.2.0                              |
| Widget [Map](../../documentation/design-studio/page-widget/data-visualization.md#map-deprecated)                                                                                                                                                                   | It will no longer be possible to use the legacy widget "Map" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.                                              | A new "map" widget will be distributed via WidgeHub. Existing widgets in pages must be manually migrated to the new widget.                                                                                                                                                                                                        | 2022.2.0                              |
| Widget [Wizard](../../documentation/design-studio/page-widget/containers.md#wizard-deprecated)                                                                                                                                                                     | It will no longer be possible to use the legacy widget "Wizard" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.                                           | A new widget will be distributed via Widget Hub. Existing widgets in pages must be manually migrated to the new widget.                                                                                                                                                                                                            | 2022.2.0                              |
| Widget [File Selector​](../../documentation/design-studio/page-widget/form.md#file-selector-file-selection)                                                                                                                                                        | It will no longer be possible to use the legacy widget "File Selector" in the page designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.                                    | A new widget will be distributed via Widget Hub. Existing widgets in pages must be manually migrated to the new widget.                                                                                                                                                                                                            | 2022.2.0                              |
| [Data Source XML](../../documentation/design-studio/tools/data-source.md#data-source-for-xml-files-deprecated)                                                                                                                                                     | It will no longer be possible to use the data source "XML". In case the removal will affect features already available in a production environment please contact your account in Decisyon.                                                                     | No alternative configuration will be provided.                                                                                                                                                                                                                                                                                     | 2022.2.0                              |
| Removal "[**Indicator Designer**](../../documentation/design-studio/application/indicator-designer.md)" and its widget "[**Indicator**](../../documentation/design-studio/page-widget/data-visualization.md#indicator-component-deprecated)" in the Page Designer. | It will no longer be possible to use the Indicator widget and Indicator Designer. In case the removal will affect features already available in a production environment please contact your account in Decisyon.                                               | <p>The alternative solution will be to create the same widget as a custom widget using widget designer or waiting that Decisyon will progressively replace the object with new dedicated widgets.</p><p>In case it will affect features already available in a production environment please contact your account in Decisyon.</p> | 2022.2.0                              |
|                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                                                                                                                                    |                                       |
