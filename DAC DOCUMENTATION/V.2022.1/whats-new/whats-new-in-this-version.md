...
{% content-ref url="../documentation/run-time/administration/jobs.md" %}
[jobs.md](../documentation/run-time/administration/jobs.md)
{% endcontent-ref %}
...
{% content-ref url="../documentation/run-time/widget-designer.md" %}
[widget-designer.md](../documentation/run-time/widget-designer.md)
{% endcontent-ref %}
...
{% content-ref url="../documentation/design-studio/tools/preferences.md" %}
[preferences.md](../documentation/design-studio/tools/preferences.md)
{% endcontent-ref %}
...
View Page Designer >>Activities Task >> [Accessing Page from External Systems](../documentation/design-studio/page-designer/activities-task.md#accessing-page-from-external-systems)
...
{% content-ref url="../documentation/design-studio/page-widget/activity-stream.md" %}
[activity-stream.md](../documentation/design-studio/page-widget/activity-stream.md)
{% endcontent-ref %}
