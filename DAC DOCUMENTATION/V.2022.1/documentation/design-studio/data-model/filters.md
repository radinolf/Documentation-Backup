...
In case data filters are necessary depending on the user, you must define the user filters, which are of the same type as the direct filters, but are applied to the groups , and remain valid for any report displayed by the end user on RunTime (please see chap. [_User_ filters](filters.md#user-filters)).
...
**Data Model>>**>>**Direct Filters management**, or the ![](<../../../.gitbook/assets/0 (30).png>) button on the tool bar.
...
![](<../../../.gitbook/assets/12 (17).png>)![](<../../../.gitbook/assets/13 (23).png>)
...
or from the toolbar, using the ![](<../../../.gitbook/assets/16 (14).png>) button.
...
To start the User Filter editor from the tool bar select the button![](<../../../.gitbook/assets/image (2).png>)
