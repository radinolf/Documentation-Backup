...
Let us remember that these are the tables used in the mapping of the **cubes**. The **measures** necessary for the analysis are defined in the cubes (_see_ _Cubes and measures_ chap.).![](<../../../.gitbook/assets/0 (14).png>)
...
**Data Model >> Metrics Management** or from the![](<../../../.gitbook/assets/1 (16).png>) button on the main bar.
...
![](<../../../.gitbook/assets/10 (17).png>)![](<../../../.gitbook/assets/11 (12).png>)
...
![](<../../../.gitbook/assets/23 (2).png>)_You select the background color to be attributed to the bar. The 200 target provides you with a good resolution for comparing the bars with each other. The Metric on DAC is shown at the bottom._
...
_Choose the graphical form (_![](<../../../.gitbook/assets/28 (3).png>) _button): In the graph leave only the part reserved to the trend, without axes and key:_
...
![](<../../../.gitbook/assets/38 (9).png>)

Step 1: **Secondary Aggregation**

![](<../../../.gitbook/assets/39 (9).png>)
...
To specify dimensioning for an _Advanced_ Metric, you must select the ![](<../../../.gitbook/assets/41 (5).png>) button.
...
_Dimensioning by week is performed by accessing the Dimensions panel through the_ ![](<../../../.gitbook/assets/45 (9).png>) _button and selecting the Week level from the Sales cube._

Step 2: **Creating the Report Using the Dimensioned Metric**

![](<../../../.gitbook/assets/46 (8).png>)
...
![SNAGHTML5d61e2](<../../../.gitbook/assets/54 (4).png>)
...
By selecting the ![](<../../../.gitbook/assets/55 (5).png>) button located on the main screen to the right of the defined filter, the system shows the Properties window which makes the metric inherit the filters available in the report where it will be used (check on the _Inherit filters_ item).
...
![SNAGHTML5e2be9](<../../../.gitbook/assets/56 (9).png>)
...
_Open the window with the list of the time functions by pressing_ ![](<../../../.gitbook/assets/63 (3).png>)

_Double-click on the Last Year time function._

Step 2: **Report with Time Advanced Metric**

![](<../../../.gitbook/assets/64 (8).png>)
...
![SNAGHTML72b9df](<../../../.gitbook/assets/65 (8).png>)
...
To access the _**Metric functions**_ window, press the ![](<../../../.gitbook/assets/69 (4).png>) button.

![](<../../../.gitbook/assets/70 (5).png>)
...
_Through the_ ![](<../../../.gitbook/assets/75 (3).png>)_button, access the window of the Metric Functions and select Sum function from the basic folder._
...
![](<../../../.gitbook/assets/100 (3).png>)

Where,

| ![](<../../../.gitbook/assets/101 (3).png>) | **Level** |
| ------------------------------------------- | --------- |
| ![](<../../../.gitbook/assets/102 (4).png>) | **Trend** |
...
*
  * The component relating to the _**level of**_ _**the series**_, calculated in a similar way to Single Exponential Smoothing ![](<../../../.gitbook/assets/104 (4).png>)
...
If the cursor is placed on Root, the system enables the button at the top left ![](<../../../.gitbook/assets/127 (2).png>).
