...
Use the ![](<../../../.gitbook/assets/1 (34).png>) button to select the _**SOURCE REPORT**_.

Use the ![](<../../../.gitbook/assets/2 (31).png>) button to select the _**SOURCE CUBE**_.

Use the ![](<../../../.gitbook/assets/3 (28).png>) button to select the _**TARGET CUBE**_ (next to the name of the cube chosen, the name of the related fact table is reported).
