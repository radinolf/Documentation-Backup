---
description: Create a new connection to access on the Design Studio.
---

# Connect on Design Studio

## Introduction

When you access on Design Studio for the first time, you need to create a New connection. This allows the user to save the connection data and the access credentials.

A new connection is created by selecting the New Connection button present in the Connection wizard. A name must be associated with a new connection for this to be distinguished from those saved previously. All the connections created are listed in the column to the left of the wizard.
...
After insert the connection parameters select Save Connect button.

### Edit or Clone Connection <a href="#edit-or-clone-connection" id="edit-or-clone-connection"></a>
