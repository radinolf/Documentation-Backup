...
To define the condition you need to click the ![](<../../../.gitbook/assets/3 (1).png>) button which opens a different window, according to the type of object selected in the _alertType_ property:
...
To define the condition you need to click the ![](<../../../.gitbook/assets/7 (7).png>) button which opens a window to insert a single condition.
...
* The **SQL Action** to execute a SQL statement. To define the query you need to click the ![](../../../.gitbook/assets/10.png) button which opens the query editor window.
...
The ![](<../../../.gitbook/assets/16 (2).png>) button starts the wizard to test the rule.

![SNAGHTML6bdd0ab8](<../../../.gitbook/assets/17 (3).png>)
