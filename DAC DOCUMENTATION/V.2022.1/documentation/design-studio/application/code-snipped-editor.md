...
![\\\fserver\projects\Manuali e training\Manuali\AppData\lrubino\AppData\Local\Temp\SNAGHTML768547.PNG](<../../../.gitbook/assets/0 (9).png>)
...
![\\\fserver\projects\Manuali e training\Manuali\AppData\sdifranc\AppData\Local\Temp\SNAGHTML41b9fc.PNG](<../../../.gitbook/assets/2 (11).png>)
...
The command button ![](<../../../.gitbook/assets/4 (9).png>) allows you to restore Eclipse default configurations (such as Java or DAC libraries)

By clicking the ![](<../../../.gitbook/assets/5 (2).png>) button, you can restore the initial Workspace situation, deleting any files and folders, and leaving the Java class associated with the _Code Snippet_ unchanged.
