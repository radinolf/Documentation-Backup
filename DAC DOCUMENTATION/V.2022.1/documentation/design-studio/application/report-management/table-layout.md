...
Note: -_Cells with text wrap option have the_ ![](<../../../../.gitbook/assets/4 (24).png>) _Button. You can remove this option by first selecting the cell and then clicking the wrap text button._![](<../../../../.gitbook/assets/5 (18).png>)_._
