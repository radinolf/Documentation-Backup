...
![](<../../../../.gitbook/assets/0 (4).png>)Formatting for totals’ rows and/or columns is set from the Total group properties.

Report totals are set from the _Totals Definition_ window opened by the button (in the toolbar).

![](<../../../../.gitbook/assets/1 (5).png>)

![](<../../../../.gitbook/assets/2 (16).png>)In the _**Operations**_ section we choose the type of total function to apply to the report, divided in the following groups:
...
_with \<entire-result> , , they are not aggregated by BU, so we carry out a sum of the BU for_ ![](<../../../../.gitbook/assets/16 (3).png>)_all quarters () and then we divide by the BU of all quarters ()_![](<../../../../.gitbook/assets/17 (13).png>)_)_
...
The ![](<../../../../.gitbook/assets/37 (1).png>) button of the totals command bar opens the _**Custom Total**_ window where it is possible to select a series of functions grouped by topic:
...
The system enables the bar to determine the new total, where the title is inserted in the Title section and clicking on the ![](<../../../../.gitbook/assets/40 (1).png>) button we access the window for the selection of functions.
...
_Finally we click on the_ ![](<../../../../.gitbook/assets/42 (1).png>) _button to save the formula and add the custom total row to the report: the system calculates the minimum between the two values of the selected cells, highlighted by the formatting of the inserted total._
