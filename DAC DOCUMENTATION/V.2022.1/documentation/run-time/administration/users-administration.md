...
If a user is automatically created as inactive, all attributes have the "Default" flag inactive.
...
{% hint style="info" %}
Users can only see and edit users with an equal or lower scoop.
{% endhint %}
