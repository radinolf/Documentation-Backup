...
**https://**_**\<PORT>/\<CONTEXT>/content/Page/\<OWNER>\_\<PAGE ID>**_**embedView?token=\&tenant=\<tenant\_id>**

\
**https://**_**\<PORT>/\<CONTEXT>/content/Page/\<OWNER>\_\<PAGE ID>**_**view?token=\&tenant=\<tenant\_id>**
