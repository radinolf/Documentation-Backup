...
{% hint style="danger" %}
This feature has been deprecated and it will be removed in a later version. You can replace it with [Action List](action-list/). Please refer to the changelog for additional information.
{% endhint %}
