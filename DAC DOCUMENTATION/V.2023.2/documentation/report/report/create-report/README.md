...
* To create,clicking on the button ![](<../../../../.gitbook/assets/image (1357).png>)
* To change, select the button below, which is only activated for already open reports ![](<../../../../.gitbook/assets/image (1277).png>)
