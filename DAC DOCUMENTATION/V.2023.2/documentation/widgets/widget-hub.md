...
<figure><img src="../../.gitbook/assets/image (519).png" alt=""><figcaption><p><a href="https://widgethub.decisyon.com/">https://widgethub.decisyon.com/</a></p></figcaption></figure>
...
![https://widgets.decisyon.com/widgets/](<../../.gitbook/assets/image (375).png>)
...
The **Upgrade** button![](<../../.gitbook/assets/image (644).png>) indicates that a new version of the Widget is available. In this case, the special folder **UPGRADES** will appear on the left, showing all the widgets that may be upgraded.
...
* The **Upgrade** button ![](<../../.gitbook/assets/image (1492).png>)  is visible in the **Install & Change Log** column. This means that a newer version is available for the widget. When you click this shortcut button,  you will be able to install the updated version immediately. The **Chage Log** button ![](<../../.gitbook/assets/image (1067).png>)opens the widget's Chage Log, allowing you to see the changes and improvements made with the latest version.
...
* By clicking the **Downgrade** shortcut button![](<../../.gitbook/assets/image (1062).png>)available in the **Install & Change Log** column.&#x20;
