...
It’s possible to use App Composer [Environment Variables](../introduction/application/overview-of-ui/general-info.md#app-composer-environment-variable) in the REST client.
