...
| ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| <p></p><p><img src="../../../.gitbook/assets/image (182).png" alt="" data-size="original"></p> | <img src="../../../.gitbook/assets/image (183).png" alt="" data-size="original"> |
...
| Before 2024.1.0                                                                                                                                                                                       | After 2024.1.0                                                                                                                                                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p></p><p><img src="../../../.gitbook/assets/image (2088).png" alt="" data-size="original"></p><p>In the previous versions you can configure the <strong>Scope</strong> associated with the user.</p> | <p></p><p><img src="../../../.gitbook/assets/image (2087).png" alt="" data-size="original"></p><p>In version 2024.1.0, you can configure the <strong>Scoope and UserScope</strong> associated with the user.</p> |
