...
<figure><img src="../../../.gitbook/assets/image (1939).png" alt=""><figcaption><p>In this Data Source, the tables created for the Excel integration are stored in a database schema named "appcomposer_temp".</p></figcaption></figure>
