...
To access this section click the Users button <img src="../../../.gitbook/assets/image (133).png" alt="" data-size="line"> located in the **Main Toolbar** of Pages.
...
2.  **Filter** **Button**![](<../../../.gitbook/assets/image (143).png>): Located in the Search field, it allows you to filter the list based on specific criteria:
...
* **Delete users** <img src="../../../.gitbook/assets/image (104).png" alt="" data-size="line">:  Remove selected users.
* **Disconnect users** <img src="../../../.gitbook/assets/image (105).png" alt="" data-size="line">: Log out selected users.
* **Enable users** <img src="../../../.gitbook/assets/image (92).png" alt="" data-size="line">:  Activate selected users.
* **Disable users**<img src="../../../.gitbook/assets/image (94).png" alt="" data-size="line">: Deactivate selected users.
...
* ![](<../../../.gitbook/assets/image (151).png>)**Search** **Field**: Search for the organization in the list.
* ![](<../../../.gitbook/assets/image (152).png>)**Create Organization Button**: Create a new organization.
