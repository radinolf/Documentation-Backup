...
The toolbar of the report can be hidden using the ![](../../../.gitbook/assets/4) button and reopened with the ![](../../../.gitbook/assets/5) button.

In the hidden form, the commands for printing and exporting (to PDF, Excel and CSV) remain available.

![](../../../.gitbook/assets/6)

The publication of the reports may be configured by the administrator directly with the hidden toolbar, which will be enabled from the toolbar open button ![](<../../../.gitbook/assets/7 (7)>).
