...
In the _weighted arithmetic average_ of the values ![](<../../../.gitbook/assets/image (589).png>), a _weight_ ![](<../../../.gitbook/assets/image (1643).png>) is assigned to each value: ![](<../../../.gitbook/assets/image (640).png>).
...
The calculation of the average requires you to sum the weighted values and divide![](<../../../.gitbook/assets/image (507).png>) them, not with respect to the number of the values but rather to the sum of the weights. Therefore the formula of the weighted average ![](<../../../.gitbook/assets/image (881).png>)is:
