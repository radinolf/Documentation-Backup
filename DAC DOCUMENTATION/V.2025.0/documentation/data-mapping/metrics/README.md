...
<figure><img src="../../../.gitbook/assets/0 (23).png" alt=""><figcaption></figcaption></figure>
...
A graph format can also be chosen for the Metric, such as bar or graph.
...
**Data Model >> Metrics Management** or from the![](<../../../.gitbook/assets/1 (24).png>) button on the main bar.
...
At the end of this operation, you will find the metrics with the logical names exchanged and all the references to them present in the system (e.g. reports, filters) will be automatically updated.
...
![](<../../../.gitbook/assets/10 (18).png>)![](<../../../.gitbook/assets/11 (6).png>)
...
![](<../../../.gitbook/assets/22 (8).png>)

_This example shows a Metric (Sales Qty) with the bar decoration._

![](<../../../.gitbook/assets/23 (9).png>)_You select the background color to be attributed to the bar. The 200 target provides you with a good resolution for comparing the bars with each other. The Metric on DAC is shown at the bottom._
...
To specify dimensioning for an _Advanced_ Metric, you must select the ![](<../../../.gitbook/assets/41 (8).png>) button.
...
_Dimensioning by week is performed by accessing the Dimensions panel through the_ ![](<../../../.gitbook/assets/45 (6).png>) _button and selecting the Week level from the Sales cube._
...
![SNAGHTML5d61e2](<../../../.gitbook/assets/54 (7).png>)
...
By selecting the ![](<../../../.gitbook/assets/55 (6).png>) button located on the main screen to the right of the defined filter, the system shows the Properties window which makes the metric inherit the filters available in the report where it will be used (check on the _Inherit filters_ item).
...
_Open the window with the list of the time functions by pressing_ ![](../../../.gitbook/assets/63.png)
