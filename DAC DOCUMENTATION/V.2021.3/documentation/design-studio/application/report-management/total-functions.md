...
![](<../../../../.gitbook/assets/0 (10).png>)Formatting for totals’ rows and/or columns is set from the Total group properties.

Report totals are set from the _Totals Definition_ window opened by the button (in the toolbar).

![](<../../../../.gitbook/assets/1 (19).png>)

![](<../../../../.gitbook/assets/2 (19).png>)In the _**Operations**_ section we choose the type of total function to apply to the report, divided in the following groups:
...
_with \<entire-result> , , they are not aggregated by BU, so we carry out a sum of the BU for_ ![](<../../../../.gitbook/assets/16 (8).png>)_all quarters () and then we divide by the BU of all quarters ()_![](<../../../../.gitbook/assets/17 (9).png>)_)_
...
_For example, if you select the column containing the description of the products \[COLS$\_ID(B) ], this function returns the ID code for each individual product._![](<../../../../.gitbook/assets/44 (1).png>)
